...
public class SetWidthDialogActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        widthBar = (SeekBar) findViewById(R.id.seekbar);
        widthBar.setProgress(width);
        widthBar.setOnSeekBarChangeListener(seekBarListener);
    ...
    void updateImageView() {
        ...
        canvas.drawCircle(125, 125, widthBar.getProgress(), p);
    ...
    public void onOKClick(View view) {
        ...
        data.putExtra("width", widthBar.getProgress());
